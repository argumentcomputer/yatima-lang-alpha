use crate::parse::error::{throw_err, ParseError, ParseErrorKind};
...
pub fn parse_base_code() -> impl Fn(Span) -> IResult<Span, Base, ParseError<Span>> {
    move |from: Span| {
        throw_err(
            alt((
                value(Base::_2, tag("b")),
...
pub fn parse_base10_digits(from: Span) -> IResult<Span, Span, ParseError<Span>> {
    context("base 10 digits", take_till1(|x| !Base::_10.is_digit(x)))(from)
}
pub fn parse_base16_digits(from: Span) -> IResult<Span, Span, ParseError<Span>> {
    context("base 16 digits", take_till1(|x| !Base::_16.is_digit(x)))(from)
}

pub fn parse_base32_digits(from: Span) -> IResult<Span, Span, ParseError<Span>> {
    context("base 32 digits", take_till1(|x| !Base::_32.is_digit(x)))(from)
}

pub fn parse_base58_digits(from: Span) -> IResult<Span, Span, ParseError<Span>> {
    context("base 58 digits", take_till1(|x| !Base::_58.is_digit(x)))(from)
}
pub fn parse_base64_digits(from: Span) -> IResult<Span, Span, ParseError<Span>> {
    context("base 64 digits", take_till1(|x| !Base::_64.is_digit(x)))(from)
}

#[must_use]
pub fn parse_base_digits(base: Base) -> Box<dyn Fn(Span) -> IResult<Span, Span, ParseError<Span>>> {
...
pub fn parse_base_bytes(base: Base) -> impl Fn(Span) -> IResult<Span, Vec<u8>, ParseError<Span>> {
    move |from: Span| {
