...
impl LitBase {
    ...
    pub fn encode<I: AsRef<[u8]>>(&self, input: I) -> Rc<str> {
        Rc::from(base_x::encode(self.base_digits(), input.as_ref()))
    }
...
pub fn parse_bin_digits() -> impl Fn(Span) -> IResult<Span, Rc<str>, ParseError<Span>> {
    move |from: Span| {
...
pub fn parse_oct_digits() -> impl Fn(Span) -> IResult<Span, Rc<str>, ParseError<Span>> {
    move |from: Span| {
...
pub fn parse_dec_digits() -> impl Fn(Span) -> IResult<Span, Rc<str>, ParseError<Span>> {
    move |from: Span| {
...
pub fn parse_hex_digits() -> impl Fn(Span) -> IResult<Span, Rc<str>, ParseError<Span>> {
    move |from: Span| {
...
pub fn parse_litbase_digits(
    base: LitBase,
) -> Box<dyn Fn(Span) -> IResult<Span, Rc<str>, ParseError<Span>>> {
