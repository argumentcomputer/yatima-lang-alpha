use crate::{
    parse::{base, span::Span},
    term::{LitType, Literal},
};

use im::Vector;
use nom::{error::ErrorKind, AsBytes, Err, IResult, InputLength};
use std::{cmp::Ordering, fmt, fmt::Write, num::ParseIntError, rc::Rc};

#[derive(PartialEq, Debug, Clone)]
pub enum ParseErrorKind {
    UndefinedReference(Rc<str>, Vector<Rc<str>>),
    TopLevelRedefinition(Rc<str>),
    UnknownLiteralType(Rc<str>),
    InvalidBaseEncoding(base::LitBase),
    UnknownBaseCode,
    ExpectedSingleChar(Vec<char>),
    InvalidBase16EscapeSequence(Rc<str>),
    MultibaseError(multibase::Error),
    CidError,
    ParseIntErr(ParseIntError),
    ReservedKeyword(Rc<str>),
    NumericSyntax(Rc<str>),
    ReservedSyntax(Rc<str>),
    LiteralLacksWhitespaceTermination(Literal),
    LitTypeLacksWhitespaceTermination(LitType),
    UnknownNatOp(Rc<str>),
    UnknownIntOp(Rc<str>),
    UnknownBitsOp(Rc<str>),
    UnknownBytesOp(Rc<str>),
    UnknownBoolOp(Rc<str>),
    UnknownTextOp(Rc<str>),
    UnknownCharOp(Rc<str>),
    UnknownU8Op(Rc<str>),
    UnknownU16Op(Rc<str>),
    UnknownU32Op(Rc<str>),
    UnknownU64Op(Rc<str>),
    UnknownU128Op(Rc<str>),
    UnknownI8Op(Rc<str>),
    UnknownI16Op(Rc<str>),
    UnknownI32Op(Rc<str>),
    UnknownI64Op(Rc<str>),
    UnknownI128Op(Rc<str>),
    InvalidSymbol(Rc<str>),
    Nom(ErrorKind),
}
