use crate::{ipld_error::IpldError, position::Pos};
use cid::Cid;
...
impl Meta {
    pub fn to_ipld(&self) -> Ipld {
        match self {
            ...
            Self::Dat(pos, bod) => Ipld::List(vec![Ipld::Integer(5), pos.to_ipld(), bod.to_ipld()]),
            Self::Cse(pos, bod) => Ipld::List(vec![Ipld::Integer(6), pos.to_ipld(), bod.to_ipld()]),
