...
impl U8Op {
  ...
  pub fn to_ipld(self) -> Ipld {
    match self {
      ...
      Self::ToChar => Ipld::Integer(23),
      Self::ToU16 => Ipld::Integer(24),
      Self::ToU32 => Ipld::Integer(25),
      Self::ToU64 => Ipld::Integer(26),
      Self::ToU128 => Ipld::Integer(27),
      Self::ToNat => Ipld::Integer(28),
      Self::ToI8 => Ipld::Integer(29),
      Self::ToI16 => Ipld::Integer(30),
      Self::ToI32 => Ipld::Integer(31),
      Self::ToI64 => Ipld::Integer(32),
      Self::ToI128 => Ipld::Integer(33),
      Self::ToInt => Ipld::Integer(34),
  ...
  pub fn from_ipld(ipld: &Ipld) -> Result<Self, IpldError> {
    match ipld {
      ...
      Ipld::Integer(23) => Ok(Self::ToChar),
      Ipld::Integer(24) => Ok(Self::ToU16),
      Ipld::Integer(25) => Ok(Self::ToU32),
      Ipld::Integer(26) => Ok(Self::ToU64),
      Ipld::Integer(27) => Ok(Self::ToU128),
      Ipld::Integer(28) => Ok(Self::ToNat),
      Ipld::Integer(29) => Ok(Self::ToI8),
      Ipld::Integer(30) => Ok(Self::ToI16),
      Ipld::Integer(31) => Ok(Self::ToI32),
      Ipld::Integer(32) => Ok(Self::ToI64),
      Ipld::Integer(33) => Ok(Self::ToI128),
      Ipld::Integer(34) => Ok(Self::ToInt),
