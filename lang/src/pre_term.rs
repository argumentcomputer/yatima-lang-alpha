...
////    match self {
////      Self::Var(_, n, i) =>
//// fmt.debug_tuple("Var").field(&n).field(i).finish(),      Self::Lam(_, n, b)
//// => fmt.debug_tuple("Lam").field(&n).field(&b).finish(),      Self::App(_, t)
//// => fmt.debug_tuple("App").field(&t).finish(),      Self::All(_, u, n, t) => {
////        fmt.debug_tuple("All").field(&u).field(&n).field(&t).finish()
////      }
////      Self::Slf(_, n, b) =>
//// fmt.debug_tuple("Slf").field(&n).field(&b).finish(),      Self::Dat(_, b) =>
//// fmt.debug_tuple("Dat").field(&b).finish(),      Self::Cse(_, b) =>
//// fmt.debug_tuple("Cse").field(&b).finish(),      Self::Ref(_, n, d, a) => {
...
////      matches!(term, Var(..) | Ref(..) | Lit(..) | LTy(..) | Opr(..) |
//// Typ(..))    }
////
...
////        }
////        (fun, App(_, a)) => {
////          format!("{} ({})", parens(rec, ind, fun), apps(rec, ind, &a.0,
//// &a.1))        }
////        (fun, arg) => {
