...
use core::fmt;
use nom::{
    self, branch::alt, bytes::complete::tag, combinator::value, IResult, InputTakeAtPosition,
};
...
impl Base {
    ...
    #[must_use]
    pub const fn base_digits(&self) -> &str {
        match self {
            Self::_2 => "01",
            Self::_8 => "01234567",
            Self::_10 => "0123456789",
            ...
            Self::_64 => "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_",
        }
    }
    ...
    pub fn decode1(self, input: Span) -> IResult<Span, Vec<u8>, ParseError<Span>> {
        let (i, o) = input
