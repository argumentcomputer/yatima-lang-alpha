...
impl I16Op {
  /// Gets the syntax string of an i16 operation
  ...
  /// Gets an i16 operation from a syntax string
  ...
  /// Returns the type of an i16 operation
  ...
  /// Converts an i16 operation into an IPLD object
  ...
  /// Converts an IPLD object into an i16 operation
